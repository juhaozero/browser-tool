...
export const relatedToolMap: Record<string, string[]> = {
  ...
  'image-convert': ['image-to-ico-svg', 'image-compressor', 'image-resizer'],
  'image-to-ico-svg': ['image-convert', 'image-resizer', 'image-compressor'],
  'image-compressor': ['image-resizer', 'image-convert', 'image-to-ico-svg'],
  'image-resizer': ['image-compressor', 'image-convert', 'image-to-ico-svg'],
